...
def unet_model(input_size=(96, 128, 3), n_filters=32, n_classes=23):
    ...
    cblock4 = conv_block(cblock3[0], 2*2*2*n_filters, dropout_prob=0.3) # Include a dropout_prob of 0.3 for this layer
    # Include a dropout_prob of 0.3 for this layer, and avoid the max_pooling layer
    cblock5 = conv_block(cblock4[0], 2*2*2*2*n_filters, dropout_prob=0.3, max_pooling=False) 
    ### END CODE HERE
    ...
    ### START CODE HERE
    ublock6 = upsampling_block(cblock5[0], cblock4[1],  2*2*2*n_filters)
    # Chain the output of the previous block as expansive_input and the corresponding contractive block output.
